...
4. Choose a workflow from `references/workflows.md`: quick QC, ERP, resting-state spectral, ERSP/ITC, ICA cleanup, BIDS/STUDY, import-plugin guidance, BIDS/data export guidance, HED event annotation guidance, history scripting guidance, event-script modification guidance, STUDY precompute/clustering guidance, source, LIMO guidance, AMICA guidance, RELICA guidance, Viewprops guidance, get_chanlocs guidance, ROIconnect guidance, EEGstats guidance, SIFT guidance, NSGportal guidance, plugin-development guidance, or report-only recovery.
...
- Use `eeglab_plugin_check` before plugin-dependent workflows: clean_rawdata, ICLabel, DIPFIT, EEG-BIDS/STUDY, BIDS export, import/export formats through BIOSIG, File-IO, MFF-matlab-io, NWB-io, BVA-io, HEDTools, STUDY precompute/clustering, firfilt, CleanLine, Zapline-Plus, AMICA, Picard, RELICA, Viewprops, get_chanlocs, ROIconnect, EEGstats, LIMO, SIFT, groupSIFT, NFT, and NSGportal.
